...
namespace Services.MessageContracts
{
    ...
    [Route(@"/clientapplications", @"POST", 
        Summary = @"Creates a new 'ClientApplication' resource", 
        Notes = @"")]
    ...
    public partial class CreateClientApplication : IReturn<CreateClientApplicationResponse>
    {
        /// <summary>
        /// Gets or sets the name of the ClientApplication
        /// </summary>
        [ApiMember(Description = "The Name of the ClientApplication. ", IsRequired = true)]
