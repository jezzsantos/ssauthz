...
namespace Services.MessageContracts
{
    ...
    [Route(@"/useraccounts/{Id}", @"PUT", 
        Summary = @"Updates an existing 'UserAccount' resource", 
        Notes = @"")]
    ...
    public partial class UpdateUserAccount : IReturn<UpdateUserAccountResponse>
    {
        /// <summary>
        ...
        /// </summary>
        [ApiMember(Description = "The Forenames of the UserAccount. ", IsRequired = false)]
        public System.String Forenames { get; set; }

        /// <summary>
        /// Gets or sets the surname of the UserAccount
        /// </summary>
        [ApiMember(Description = "The Surname of the UserAccount. ", IsRequired = false)]
        public System.String Surname { get; set; }

        /// <summary>
        /// Gets or sets the oldpasswordhash of the UserAccount
        /// </summary>
        [ApiMember(Description = "The OldPasswordHash of the UserAccount. ", IsRequired = false)]
        public System.String OldPasswordHash { get; set; }

        /// <summary>
        /// Gets or sets the newpasswordhash of the UserAccount
        /// </summary>
        [ApiMember(Description = "The NewPasswordHash of the UserAccount. ", IsRequired = false)]
        public System.String NewPasswordHash { get; set; }

        /// <summary>
        /// Gets or sets the address of the UserAccount
        /// </summary>
        [ApiMember(Description = "The Address of the UserAccount. ", IsRequired = false)]
