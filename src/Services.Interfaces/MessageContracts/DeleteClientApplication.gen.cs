...
namespace Services.MessageContracts
{
    ...
    [Route(@"/clientapplications/{Id}", @"DELETE", 
        Summary = @"Deletes an existing 'ClientApplication' resource", 
        Notes = @"")]
    ...
    public partial class DeleteClientApplication : IReturn<DeleteClientApplicationResponse>
    {
        /// <summary>
